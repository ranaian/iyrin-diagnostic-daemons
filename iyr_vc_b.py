...
def get_battery_info(bat_id):
    ...
    try:
        ...
        return {
            ...
            "Percentage": round(int(read_file("energy_now")) / int(read_file("energy_full")) * 100, 2),
